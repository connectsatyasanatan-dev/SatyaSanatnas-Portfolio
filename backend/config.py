"""
config.py — Production-ready Flask configuration
Reads all settings from environment variables (backed by .env via python-dotenv).
Never hard-code secrets here; use .env for local development and set real
environment variables on the deployment platform (Render / Railway / etc.)
"""
...
class Config:
    ...
    # Example (production): https://your-portfolio.vercel.app
    # ------------------------------------------------------------------ #
